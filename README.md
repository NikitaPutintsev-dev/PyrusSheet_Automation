...
Сервис периодически читает Google Таблицу и для каждой **новой** строки (без ID задачи в Pyrus) создаёт задачу по форме через [Pyrus API v4](https://pyrus.com/en/help/api/tasks). Соответствует ТЗ в [TZ.md](TZ.md).
